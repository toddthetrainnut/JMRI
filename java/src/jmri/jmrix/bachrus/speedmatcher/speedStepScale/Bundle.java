 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrix.bachrus.speedmatcher.Bundle {

    @Nullable
    private static final String name = "jmri.jmrix.bachrus.speedmatcher.speedStepScale.SpeedStepScaleSpeedMatcherBundle";
